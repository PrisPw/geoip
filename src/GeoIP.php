...
use PrisPW\GeoIP\Exceptions\GeoIPException;
...
class GeoIP
{
    ...
    /**
     * @var \PrisPW\GeoIP\Contracts\GeoIPInterface
     */
    protected $driver;
     ...
     * Getter for driver.
     *
     * @return \PrisPW\GeoIP\Contracts\GeoIPInterface
     */
     ...
     * Get an array or single item of geoip data.
     *
     * @throws \PrisPW\GeoIP\Exceptions\GeoIPException
     *
     * @return array
     */
